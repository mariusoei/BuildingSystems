...
model MultiLayerHeatConduction1DNodesVariable
  "Multi layered-body with 1D heat conduction and a potential inner discretization of each layer"

  BuildingSystems.HAM.HeatConduction.HeatConduction1DNodesVariable layer[nLayers](
    material=material,
...
end MultiLayerHeatConduction1DNodesVariable;
